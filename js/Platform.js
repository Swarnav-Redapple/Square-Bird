class Platform {
    ...
    CreateBottomPlatform() {
        ...
        this.posOne = bottomPlatformOne.x;
        ...
        this.colliderArray_One.push(collider_One);
        ...
        this.colliderArray_One.push(collider_Two);
        ...
        this.colliderArray_One.push(collider_Three);
        ...
        this.colliderArray_One.push(collider_Four);
        ...
        this.bottomPlatformArray_One.push(bottomPlatformTwo);
        ...
        this.colliderArray_One.push(collider_Five);
        ...
        this.colliderArray_One.push(collider_Six);
        ...
        this.colliderArray_One.push(collider_Seven);
        ...
        this.colliderArray_One.push(collider_Eight);
        ...
        this.colliderArray_One.push(collider_Nine);
        ...
        this.colliderArray_One.push(collider_Ten);
        ...
        this.colliderArray_One.push(collider_Eleven);
        this.bottomContainer_Two.add(collider_Eleven);
        this.bottomAllArray_One.push(this.bottomPlatformArray_One, this.colliderArray_One);
        console.log(this.bottomAllArray_One);
        ...
        this.posTwo = bottomPlatformThree.x;
        ...
        this.bottomPlatformArray_Two.push(bottomPlatformThree);
        ...
        this.colliderArray_Two.push(collider_Twelve);
        ...
        this.colliderArray_Two.push(collider_Thirteen);
        ...
        this.colliderArray_Two.push(collider_Fourteen);
        ...
        this.colliderArray_Two.push(collider_Fifteen);
        ...
        this.colliderArray_Two.push(collider_Sixteen);
        ...
        this.colliderArray_Two.push(collider_Seventeen);
        ...
        this.colliderArray_Two.push(collider_Eighteen);
        this.bottomContainer_Three.add(collider_Eighteen);
        this.bottomAllArray_Two.push(this.bottomPlatformArray_Two, this.colliderArray_Two);
        console.log(this.bottomAllArray_Two);
        ...
        this.posThree = bottomPlatformFour.x;
        ...
        this.bottomPlatformArray_Three.push(bottomPlatformFour);
        ...
        this.colliderArray_Three.push(collider_Nineteen);
        ...
        this.colliderArray_Three.push(collider_Twentieth);
        ...
        this.colliderArray_Three.push(collider_TwentyOne);
        ...
        this.colliderArray_Three.push(collider_Twentytwo);
